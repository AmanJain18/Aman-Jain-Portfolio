  ...
  init: function () {
    ...
    $("#submit").click(function () {
      ...
      if ($(".contact-form .required").size() > 0) {
        ...
        var data = {
          service_id: "gmail",
          template_id: "template_p7wtr93", // keys from email.js
          user_id: "UCQhsAFOASSjTSKor", // keys from email.js
          template_params: {
...
function initMap() {
  ...
  marker
    .bindPopup("Aman lives here, come over for a cup of coffee 🙂")
    .openPopup();
  setTimeout(function () {
...
window.goBack = function (e) {
  var defaultLocation = "http://127.0.0.1:5500/";
...
app.ui = {
  ...
  navMenu: function () {
    $(document).on(
      "click",
      "#nav_bar nav a,.flat-button, a.logo, .tips-logo-cont a",
      function (e) {
        e.preventDefault();
